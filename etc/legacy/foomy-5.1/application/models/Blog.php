...
class Model_Blog extends Zend_Db_Table_Row_Abstract
{
    protected $_primary = Model_Blog_Peer::F_ID;
    ...
    {
        return $this->{Model_Blog_Peer::F_ID};
    }// getId()
    ...
    {
        return $this->{Model_Blog_Peer::F_CREATED};
    }// getCreated()
    ...
    {
        return $this->{Model_Blog_Peer::F_MODIFIED};
    }// getModified()
    ...
    {
        return $this->{Model_Blog_Peer::F_TITLE};
    }// getTitle()
    ...
    {
        return $this->{Model_Blog_Peer::F_SUBTITLE};
    }// getSubTitle()
    ...
    public function getArticles() {
        return Model_Article_Peer::getArticles($this->{Model_Blog_Peer::F_ID});
    }// getArticles()
    ...
    {
        return Model_Article_Peer::getById($artId);
    }// getArticle()
